  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="sharenews.php">Write Something!<span class="glyphicon glyphicon-pencil ml-3"></span></a></li>
...
<section>
  ...
  if($result->num_rows>0) {
    ...
    <div class="panel panel-danger">
      <div class="panel-heading text-centre text-dark"><b><?php echo $row['heading'];?></b></div>
        <div class="panel-body panel-danger">
      <h5 class="text-left"><i><?php echo $row['writer'];?></i></h5>
      <h5 class="text-left"><i><?php echo $row['Dt'];?></i></h5>
