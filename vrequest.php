    ...
    if ($result->num_rows>0) {
      ...
      { ?>
        <tr><b>
          ...
          <td><a href="accept.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm mr-2" role="button">Accept</a><a href="reject.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm mr-2" role="button">Reject</a></td>
        </b></tr>
