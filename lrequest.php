...
<div class="row">
<div class="col-md-8">
<h2 class="text-center text-dark">Leave Request</h2>
  ...
  <div class="form-group">
    <label >Reason</label>
    <input type="text" class="form-control" name="reason" placeholder="Description">
  </div>
    <div class="form-group col-md-12">
      <label for="mobile">Mobile No.</label>
      <input type="text" class="form-control" onkeypress="return validatephone(event);" maxlength="10" minlength="10" name="mobile" placeholder="Mobile">
  </div>
  <div class="form-row">
  ...
  <div class="form-group">
    <label >Status</label>
    <input  value="On Hold" class="form-control" name="status" readonly>
  </div>

    <div class="form-group">
    <button type="submit" class="btn btn-primary btn-block" name="submit">Request</button>
  </div> 
  </form>
</div>
</div>
