 ...
 font-family: "Bauhaus 93", Times, serif; 
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="admin.php">EMPTAL</a>
    </div>
...
<h3 class="text-dark h">Welcome!</h3>
      ...
      <ul class="nav navbar-nav">
         <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown"  href="#">EMPLOYEE
           ...
           <?php
$sql="SELECT * FROM register where active='2' ";
$result=$conn->query($sql);
?>
          <ul class="dropdown-menu">
             <li><a class="dropdown-item" href="user.php">ACTION</a></li>
          <li><a class="dropdown-item" href="userrequest.php">REQUEST<span class="badge"><?php echo $result->num_rows; ?></span></a></li>
          </ul>
        </li>
         <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">AWARD
            <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="addaward.php">ADD</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="addproduct.php">ADD</a></li>
          </ul>
        </li>
        <li>
