    ...
    if ($result->num_rows>0) {
      ...
      { ?>
        <tr>
          ...
          <td><a href="acceptuser.php?id=<?php echo $row['userid']; ?>" class="btn btn-success btn-sm mr-2" role="button">Accept</a><a href="rejectuser.php?id=<?php echo $row['userid']; ?>" class="btn btn-danger btn-sm mr-2" role="button">Reject</a></td>
        </tr>
