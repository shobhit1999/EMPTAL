...
<div class="row">
<div class="col-md-8">
<h2 class="text-center text-dark">Write Something!</h2>
  <form action="dbnews.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
    <label for="heading" class="text-dark">Heading</label>
    <textarea type="text" class="form-control" name="heading" row="2" placeholder="News Heading" required></textarea>
    </div>
    <div class="form-group">
  ...
  <div class="form-group">
    <button type="submit" class="btn btn-primary btn-block" name="submit">Upload News</button>
  </div>
  <?php
   if(isset($_SESSION['shared'])){
   ?>  
   <p class="text-center text-dark">Shared Sucessfully!</p>
  <?php
