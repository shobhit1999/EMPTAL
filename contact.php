...
<section>
  ...
  if($result->num_rows>0) {
    ...
    <div class="panel panel-success">
      <div class="panel-heading text-centre text-dark"><b><?php echo $row['name'];?></b></div>
        <div class="panel-body panel-danger">
      <h5 class="text-left"><i><?php echo $row['email'];?></i></h5>
      <p class="text-left"><?php echo $row['comment'];?></p>
      </div>  
    </div>
</div>
     <?php
