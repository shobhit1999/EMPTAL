...
<div class="row">
<div class="col-md-8">
<h2 class="text-center text-dark">Register Products</h2>
  <form action="dbproduct.php" method="POST">
    ...
    <div class="form-group col-md-6">
      <label for="code" class="text-dark">Product Id</label>
      <input type="text" class="form-control" name="code" placeholder="Product ID" required>
    </div>
    <div class="form-group col-md-6">
      <label for="img_src" class="text-dark">Image Address</label>
      <input type="text" class="form-control" name="img_src" placeholder="Image Address" required>
    </div>
  </div>
  <div class="form-group">
